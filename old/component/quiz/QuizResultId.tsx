...
const QuizResultID = ({ result2 }: { result2: any }) => {
    const cardBg = 'white'
    ...
    function calculateScore(answers: any) {
        ...
        return Math.round(percentage) // returns string like "50.00"
    }
                ...
                <Box py={12} px={8}>
                    <VStack spaceX={6} textAlign="center">
                        ...
                        <HStack spaceX={2}>
                            {[0, 1, 2, 3, 4].map((star) => (
                                <WinnerStarIcon
                                    filled={calculateScore(result2.answers) > (star * 20) ? true : false}
                        ...
                        <VStack spaceX={2}>
                            ...
                            >
                                <Text
                                    ...
                                    lineHeight="none"
                                >
                                    {calculateScore(result2.answers)} %
                                </Text>
                            </Box>
                        </VStack>
                        ...
                        <Text
                            ...
                            maxW="280px"
                        >
                            Your score {countCorrect(result2.answers)} out of {result2.answers.length} question
                        </Text>
                        <Box h={"full"} />
                        {/* Continue Button */}
                        <Button
