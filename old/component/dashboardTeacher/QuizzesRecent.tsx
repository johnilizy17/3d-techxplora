...
export default function QuizzesRecent({ data }: { data: any }) {
        ...
        <Box px={{ base: 4, md: 16 }} mt={[4, 8]} py={4}>
            ...
            <SimpleGrid columns={{ base: 2, md: 3 }} gap={4}>
                {user.accountable_type === "App\\Models\\Student" ?
                    <CardRoot
                        onClick={() => router.push("/dashboard/quizzes/join")}
                        borderRadius={"12px"}
                        cursor="pointer" h="135px" _hover={{ transform: "scale(1.01)", transition: "0.2s ease" }} pos="relative" bg="#eef0fe">
                        <CardBody p={4}>
                            <Center h="full">
                                <AddIcon /> <Box color={COLORS.blue} fontWeight={"700"} ml="8px" fontFamily={"Plus Jakarta Sans"} fontSize={"14px"}>Join Quiz</Box>
                            </Center>
                        </CardBody>
                    </CardRoot>
                    :
                    <CardRoot
                        ...
                        <CardBody p={4}>
                            <Center h="full">
                                <AddIcon /> <Box color={COLORS.blue} fontWeight={"700"} ml="8px" fontFamily={"Plus Jakarta Sans"} fontSize={"14px"}>Create Quiz</Box>
                            </Center>
                        </CardBody>
                    </CardRoot>
                }
                    ...
                    <CardRoot
                        ...
                        <CardBody p={4}>
                            <Flex
                                ...
                                <Box>
                                    <Text fontWeight="600" lineClamp={2} fontFamily={"Poppins"} fontSize={["12px", "14px"]} color="#4f42c0">
                                        {quiz.title}
                                    </Text>
                                    <Text lineClamp={1} pr="20px" mt="10px" fontSize={["10px", "12px"]} fontFamily={"Poppins"} color="#8300A5">
                                        {quiz.description}
                                    </Text>
                                </Box>
