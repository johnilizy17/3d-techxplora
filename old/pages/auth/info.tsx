...
import QuizJoin from "@/template/join/quiz";
import AdminVerify from "@/template/verify/AdminVerify";
import GroupVerify from "@/template/verify/group";
import QuizVerify from "@/template/verify/quiz";
...
export default function Info() {
    ...
    const { temporary } = useSelector((a: { auth: { temporary: any} }) => a.auth)

    return (
        <AuthLayout title="Verify Group">
            <CloseLayout>
                <Box
                    h="100vh"
                    bg={COLORS.bg_gray}
                ...
                >
                    <Stack mb={4} w="full">
                        <Center justifyContent={"start"}>
                            <Text mr="5px" color={COLORS.deep_black} fontWeight="700" fontFamily="Poppins" fontSize={{ base: "17px", md: "20px" }} lineHeight={{ base: "22px", md: "26px" }}>
                        ...
                        <Text fontSize="14px" color={COLORS.light_gray}>
                            Start creating quiz with ease
                        </Text>
                    </Stack>
                    <AdminVerify temporary={temporary} />
                </Box>
            </CloseLayout>
        </AuthLayout>
    );
