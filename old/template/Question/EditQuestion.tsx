...
export default function EditQuestion({ number, setNumber }: { number: number, setNumber: any }) {
    ...
    const HandleQuiz = async (values: any, { setSubmitting, resetForm }: any) => {
        try {
            ...
            quiz[number] = { question: values.question, question_id: editQuiz.questions[number].question_id, options: answers }
            setSubmitting(true)
